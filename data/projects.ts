...
export const projects: Project[] = [
  {
    ...
    image: "codefyai.png",
    about: "A toolbox of powerful AI coding widgets built to help developers speed up their workflow. Achieved 5,000 user sign ups and 80+ subscriptions in two weeks.",
    buttons: [
      {
        label: "Try it out",
        link: "https://www.codefy.ai"
  ...
  {
    title: "Pygolf",
    about: "Create and share Python code golf challenges. Uses Python Shell to compile scripts in the backend.",
  ...
  {
    title: "Pixel Engine",
    about: "A minimalist online game engine. Write games directly in the browser and export as an HTML file.",
  ...
  {
    title: "Symbl",
    about: "An interpreted symbol-based language inspired by BF. An experiment in esoteric programming languages and command simplification.",
  ...
  {
    title: "SleekScript",
    about: "A pythonic, browser-based language that compiles to JavaScript. Inspired by CoffeeScript.",
  ...
  {
    title: "GameScript",
    about: "A wrapper for common Pygame functions. Built to prevent code redundancy in Pygame projects.",
  ...
  },
  {
    ...
    about: "Team communication and coordination all in one place. Old version of the project, written in vanilla React.",
    link: "https://devcomms.io",
    image: "devcomms.png",
    buttons: [
      {
  ...
  {
    title: "ImgScript",
    about: "An image-based programming language. An experiment in esoteric programming languages.",
  ...
  {
    title: "Calendar",
    about: "Event scheduling in a simple interface. Uses Firebase for authentication and data storage.",
  ...
  {
    title: "SimpleStore",
    about: "Built to experiment with file storage. Features file uploading and folder creation. Uses Firebase for authentication and file storage.",
  ...
  {
    title: "Mono2D",
    about: "A 2D raycasting engine built in MonoGame. My first major C# game framework project. Features collision detection.",
  ...
  {
    title: "Meta Python",
    about: "Python written in Python. An experiment in code lexing and parsing.",
  ...
  {
    title: "Widget Wall",
    about: "A webpage with a collection of useful widgets. Uses Firebase for backend and connects with several APIs, including Datamuse and Bit.ly.",
  ...
  },
  {
    ...
    about: "Highlights from my personal Python projects. Features many experiments built with Pygame.",
  ...
  {
    title: "MinScript",
    about: "A minimalist programming language written in Python. My first experimental programming language.",
  ...
  },
  {
    ...
    about: "A countdown tracker tool. Uses Firebase for the backend and features a toggleable background.",
  ...
  {
    title: "Playlist Bot",
    about: "Input your preferences to generate Spotify playlists. Uses the Spotify API to search songs and save playlists.",
  ...
  },
  {
    ...
    about: "A ticket tracker tool. My first use of a database in web development, uses Firebase to store users and ticket data.",
  ...
  },
  {
    ...
    about: "A collection of common coding challenges in various languages. Features challenges in C#, C++, Python, Java, and JavaScript.",
  ...
  {
    title: "Jamming",
    about: "A Spotify playlist builder. My first usage of an API in an app, uses the Spotify API to search songs and save playlists.",
  ...
  {
    title: "Countdown",
    about: "A lightweight, downloadable countdown tracker. Features color customization. Built in Unity.",
  ...
  {
    title: "2048 Live",
    about: "\"2048\" controlled through real-time object detection. My first major project in C++, uses OpenCV for camera and SDL2 for drawing.",
  ...
  },
  {
    ...
    about: "An interactive visualization tool for eight common sorting algorithms. Uses Unity WebGL to run in the browser.",
  ...
  {
    title: "Chess",
    about: "Play chess against a basic AI. Built to experiment with the implementations of chess rules.",
  ...
  },
  {
    ...
    about: "An interactive step-by-step visualization of the A* pathfinding algorithm. Uses Unity WebGL to run in the browser.",
  ...
  {
    title: "Diapixel",
    about: "A minimal 2D and 3D diagramming tool built in a day. Built to experiment with 2D and 3D movement in Unity.",
  ...
  {
    title: "Computeroid",
    about: "A top-down puzzle game with a retro computer theme. My first major game project, built in Unity over 2 months.",
